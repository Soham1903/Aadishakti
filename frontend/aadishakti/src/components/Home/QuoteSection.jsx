...
const QuoteSection = () => {
  return (
    <section className="py-8 md:py-12 lg:py-16 bg-gradient-to-r from-[#921a40]/5 to-purple-50">
      <div className="max-w-5xl mx-auto px-4 md:px-8">
        <div className="relative">
          ...
          <div className="absolute bottom-0 right-0 text-[#921a40]/20">
          ...
          <blockquote className="text-center px-4 md:px-6 lg:px-8 py-2 animate-[fadeIn_0.6s_ease-in]">
            <p className="text-lg md:text-xl lg:text-2xl font-medium leading-relaxed text-gray-800 mb-4 md:mb-6">
              ...
              <span className="text-[#921a40] font-semibold"> सर्व शास्त्र म्हणजे एकाच नाण्याच्या अनेक बाजू आहेत.</span>
            </p>
            ...
            <footer className="mt-6 md:mt-8">
              <div className="w-12 md:w-16 h-1 bg-[#921a40] mx-auto mb-3 md:mb-4"></div>
