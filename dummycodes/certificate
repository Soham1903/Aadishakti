...
function CourseLinks() {
  ...
  const updateProgress = (videoIndex) => {
    const updated = new Set([...watchedVideos, videoIndex]);
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-lg mb-4">
                  {course.description ||
                    "Master the concepts with our comprehensive video series"}
                </p>
            ...
            {course.links && course.links.length > 0 ? (
              ...
              <div className="bg-white border-2 border-dashed border-gray-300 rounded-2xl p-12 text-center">
                ...
                <p className="text-gray-500">
                  Videos for this course will be available soon. Check back
                  later!
                </p>
              </div>
            )}
              ...
              <div className="flex flex-col space-y-3">
                {isComplete ? (
                  <>
                    <button
                      onClick={() =>
                        navigate(`/courses/${course.courseId}/certificate`)
                      }
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  className={`h-3 rounded-full transition-all duration-500 ${
                    isComplete
                      ? "bg-green-500"
                      : "bg-gradient-to-r from-[#921a40] to-[#b91c47]"
                  }`}
